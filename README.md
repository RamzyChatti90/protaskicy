...
![Protaskicy CI/CD Pipeline](https://github.com/OWNER/protaskicy/actions/workflows/main.yml/badge.svg)
...
To build the final jar and optimize the protaskicy application for production, run:
